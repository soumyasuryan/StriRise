    ...
    <nav className="w-full bg-pink-200 shadow-md">
      <div className="max-w-auto mx-10 px-6 py-5 flex justify-between items-center">
        ...
        <Link href="/" className="text-2xl font-bold text-pink-700">
          <img src="/trace.svg" className="h-15 rounded-[50%]" alt="" />
        </Link>
      ...
      {isOpen && (
        <div className="md:hidden bg-pink-100 px-6 pb-4 space-y-3 text-pink-800 font-medium">
          ...
          <Link href="/skill-recommendation" className="block hover:text-pink-600">Skill Recommendation</Link>
          <Link href="/ai-roadmap" className="block hover:text-pink-600">AI Roadmap</Link>
          <Link href="/marketplace" className="block hover:text-pink-600">Marketplace</Link>
